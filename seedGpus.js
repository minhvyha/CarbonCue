...
const Gpus = mongoose.models.Gpus || mongoose.model("Gpus", gpuSchema);
...
(async () => {
  try {
    await mongoose.connect("mongodb+srv://minhvyha:minhvy828@carboncue.vq85gob.mongodb.net/");
    console.log("✅ Connected to MongoDB");

    await Gpus.deleteMany({});
    await Gpus.insertMany(gpuData);
